...
set :branch, "master"
set :repository,  "https://github.com/HumbleLivelyBear2/restaurant_server.git"
set :scm, "git"
set :user, "apps" # 一個伺服器上的帳戶用來放你的應用程式，不需要有sudo權限，但是需要有權限可以讀取Git repository拿到原始碼
set :port, "222"

set :deploy_to, "/home/apps/restaurant"
set :deploy_via, :remote_cache
set :use_sudo, false

role :web, "106.187.100.252"
role :app, "106.187.100.252"
role :db,  "106.187.100.252", :primary => true
